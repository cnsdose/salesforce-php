...
class StatusCode extends Enum
{
    ...
    const CLONE_FIELD_INTEGRITY_EXCEPTION = 'CLONE_FIELD_INTEGRITY_EXCEPTION';
    const CLONE_NOT_SUPPORTED = 'CLONE_NOT_SUPPORTED';
    ...
    const EXCEEDED_MAX_SEMIJOIN_SUBSELECTS_WRITE = 'EXCEEDED_MAX_SEMIJOIN_SUBSELECTS_WRITE';
    ...
    const SALESFORCE_INBOX_TRANSPORT_INVALID_INPUT_ERROR = 'SALESFORCE_INBOX_TRANSPORT_INVALID_INPUT_ERROR';
