...
class ExtendedErrorCode extends Enum
{
    ...
    const BOTH_START_NODE_AND_REFERENCE_FOUND = 'BOTH_START_NODE_AND_REFERENCE_FOUND';
    ...
    const CONDITION_OPERAND_DATATYPES_INCOMPATIBLE = 'CONDITION_OPERAND_DATATYPES_INCOMPATIBLE';
    const CONDITION_OPERATOR_INCOMPATIBLE = 'CONDITION_OPERATOR_INCOMPATIBLE';
    ...
    const FLOW_REFERENCES_APEX_CLASS_NOT_IN_SAME_PACKAGE = 'FLOW_REFERENCES_APEX_CLASS_NOT_IN_SAME_PACKAGE';
    const FLOW_SCHEDULE_INFORMATION_INCOMPLETE = 'FLOW_SCHEDULE_INFORMATION_INCOMPLETE';
    ...
    const FLOW_SYSTEM_VARIABLE_NOT_SUPPORTED_FOR_TRIGGERTYPE = 'FLOW_SYSTEM_VARIABLE_NOT_SUPPORTED_FOR_TRIGGERTYPE';
    ...
    const NON_EXPOSED_COMPONENT_IN_FLOW = 'NON_EXPOSED_COMPONENT_IN_FLOW';
    const NON_GLOBAL_COMPONENT_IN_EXPORTED_FLOW = 'NON_GLOBAL_COMPONENT_IN_EXPORTED_FLOW';
    ...
    const OBJECT_TYPE_DOES_NOT_EXIST = 'OBJECT_TYPE_DOES_NOT_EXIST';
    ...
    const PAST_SCHEDULE_FLOW_WILL_NOT_RUN = 'PAST_SCHEDULE_FLOW_WILL_NOT_RUN';
    ...
    const RECORDFILTER_NON_PRIMITIVE = 'RECORDFILTER_NON_PRIMITIVE';
    ...
    const SCREENCOMPONENT_CONTAINS_VISIBILITY_RULE = 'SCREENCOMPONENT_CONTAINS_VISIBILITY_RULE';
    ...
    const SETTING_FIELD_VALUE_MAKES_OTHER_FIELD_UNSUPPORTED = 'SETTING_FIELD_VALUE_MAKES_OTHER_FIELD_UNSUPPORTED';
    ...
    const TRIGGER_TYPE_INCOMPATIBLE_WITH_PROCESS_TYPE = 'TRIGGER_TYPE_INCOMPATIBLE_WITH_PROCESS_TYPE';
    ...
    const VISIBILITY_RULE_EXCEEDS_CONDITION_LIMIT = 'VISIBILITY_RULE_EXCEEDS_CONDITION_LIMIT';
    const VISIBILITY_RULE_NOT_AVAILABLE_IN_ORG = 'VISIBILITY_RULE_NOT_AVAILABLE_IN_ORG';
    const VISIBILITY_RULE_NOT_SUPPORTED = 'VISIBILITY_RULE_NOT_SUPPORTED';
    const VISIBILITY_RULE_NOT_SUPPORTED_FOR_API_VERSION = 'VISIBILITY_RULE_NOT_SUPPORTED_FOR_API_VERSION';
    const VISIBILITY_RULE_NOT_SUPPORTED_FOR_PROCESSTYPE = 'VISIBILITY_RULE_NOT_SUPPORTED_FOR_PROCESSTYPE';
    const VISIBILITY_RULE_NO_CONDITIONS = 'VISIBILITY_RULE_NO_CONDITIONS';
